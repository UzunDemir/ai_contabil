...
if prompt := st.chat_input("Введите ваш вопрос..."):
    ...
    if not relevant_chunks:
      ...
      Анализ не надо выводить, это секрет, но его надо использовать для построения беседы. Используй весь полученный анализ и информацию о собеседнике. Задача - помочь ему.
